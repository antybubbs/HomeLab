...
Kaya stores its SQLite database at `data/kaya.db`. On upgrade from an older HomeLab install, the container will migrate `data/homelab.db` to the Kaya filename on first startup.
